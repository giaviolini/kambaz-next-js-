...
export default function CourseNavigation() {
  return (
    <div id="wd-courses-navigation">
      ...
      <Link href="/Kambaz/Courses/1234/Quizzes">Quizzes</Link><br/>
      <Link href="/Kambaz/Courses/1234/Grades">Grades</Link><br/>
      <Link href="/Kambaz/Courses/1234/People/Table">People</Link><br/>
    </div>
  );}
