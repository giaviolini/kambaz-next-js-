export default function Lab1() {
    return (
      <div id="wd-lab1">
        <h2>Lab 1</h2>
        <h3>HTML Examples</h3>
        <h4>Web Design Assignment due: 9/19 - Gia Violini</h4>
        <div id="wd-h-tag">
          <h4>Heading Tags</h4>
        ...
        <div id="wd-lists">
          ...
          <ol id="wd-your-favorite-recipe">
            <li>first make ricotta mixture: mix together ricotta, egg, parmasan, and herbs untill egg is fully combined.</li>
            <li>add in uncooked spinach into ricotta mixture</li>
            <li>add a bit of sauce to bottom of pan</li>
            <li>stack in alternating order: noodle, sauce, ricotta mixture, motz</li>
            <li>once stacking is done, top with mozts to finish</li>
            <li>wrap with foil</li>
            <li>in oven at 400 for 40 ish minutes, check accordingly</li>
          </ol>
        </div>
        ...
        {/* <form id="wd-text-fields"> */}
          ...
          <input placeholder="e.g., jdoe" id="wd-text-fields-username" /> <br />
          <label htmlFor="wd-text-fields-password">Password:</label>
          <input type="password" id="wd-text-fields-password" value="123@#$asd" /> <br />
          <label htmlFor="wd-text-fields-first-name">First name:</label>
          <input type="text" title="e.g., John" id="wd-text-fields-first-name" /> <br />
          <label htmlFor="wd-text-fields-last-name">Last name:</label>
          <input type="text" placeholder="Doe" defaultValue="Wonderland" title="The last name"
