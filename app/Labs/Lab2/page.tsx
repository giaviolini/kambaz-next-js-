...
import Posititons from "./Positions";
...
export default function Lab2() {
  return (
    ...
    <div id="wd-lab2">
      ...
      </div> <ForegroundColors /> <BackgroundColor /> <Borders /> <Padding /> <Margins /> 
      <Corners /> <Dimensions /> <Posititons /> <Zindex /> <Float/> <GridLayout /> <Flex />
      <ReactIconsSampler /> <BootstrapGrid /> <ScreenSizeLabel /> <BootstrapTables /> 
      <BootstrapLists /><BootstrapForms/> <BootstrapNavigation />
    </div>
    </Container> 
    );}
